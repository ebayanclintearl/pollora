...
abstract final class AppSpacing {
  ...
  /// Standard icon-button container (visual size, touch via GestureDetector).
  static const double iconBtn     = 44.0;
  ...
  static const EdgeInsets screenPadH = EdgeInsets.symmetric(horizontal: screenH);
